...
##########################
parallel_nHDPJags_i_S1a_K <- function(i,Yall,path,K){
...
# Here, you need to change the size of the dataset withing the parallel nHDPjags functions
...
# mclapply(1:30,parallel_nHDPJags_i_K,
...
##########################
parallel_nHDPJags_i_S2_K <- function(i,Yall,path,K){
  J <- c(2,4,6)
